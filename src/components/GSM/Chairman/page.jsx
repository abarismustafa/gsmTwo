                ...
                <div className="card-body p-4">
                  ...
                  <blockquote className="blockquote mb-4">
                    <p className="fs-5" style={{ lineHeight: "1.9" }}>
                      ...
                      पहुंचें। इसी उद्देश्य को ध्यान में रखते हुए ग्रामीण
                      स्वास्थ्य मित्र (GSM) परियोजना की शुरुआत की गई है। यह पहल
                      हमारे देश के उन लाखों ग्रामीण परिवारों के लिए समर्पित है,
                      जिन्हें समय पर सही स्वास्थ्य परामर्श और स्क्रीनिंग उपलब्ध
                      नहीं हो पाती।
                    </p>
                  </blockquote>
                  ...
                  <p className="fs-5 lh-lg">
                    ...
                    स्क्रीनिंग, पंजीकरण और स्वास्थ्य संबंधी जानकारी को समय पर
                  ...
                  <p className="fs-5 lh-lg">
                    ...
                    <strong>
                      हमारा लक्ष्य है कि हर परिवार स्वस्थ, हर गांव सशक्त और हर
                      नागरिक सुरक्षित रहे।
                    </strong>
                  </p>
