            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body p-4">
                  ...
                  <h3 className="fw-bold text-primary">Dr.Arun Kumar</h3>
                  ...
                  >
                    ...
                    <p className="d-inline fs-5 ms-2">
                      प्रिय देशवासियों, ग्रामीण स्वास्थ्य मित्र (GSM) परियोजना केवल
                      एक सामाजिक पहल नहीं, बल्कि एक व्यापक राष्ट्रीय स्वास्थ्य
                      मिशन है, जिसका उद्देश्य है – भारत के हर नागरिक तक आधुनिक और
                      सुलभ स्वास्थ्य सुविधाएँ पहुँचाना।
                    </p>
                  </div>
                  ...
                  <ul className="fs-5 lh-lg">
                    <li>
                      प्रत्येक पंजीकृत ग्रामीण स्वास्थ्य मित्र को ₹10,000 मूल्य का
                      पैड (Tab/Pad) प्रदान किया जाए, जिससे स्वास्थ्य डेटा डिजिटल
                      संग्रहित और ट्रैक किया जा सके।
                    </li>
                    <li>
